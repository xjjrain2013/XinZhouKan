...
( function( undefined ) {
	...
	Backbone.Semaphore = {
		...
		//捕获： 如果‘在用的许可证数’超过‘有效的许可证数’则抛出错误， 否则将在用许可证数加 1
		acquire: function() {
		...
		//释放： 如果‘在用的许可证数’为0则抛出错误， 否则将在用许可证减 1
		release: function() {
		...
		//锁定： 如果‘在用的许可证数’大于0 ， 则处于锁定， 否处于解锁
		isLocked: function() {
			return this._permitsUsed > 0;
		},
		
		//设置‘有效的许可证数’， 如果‘在用的许可证数’大于传入的有效许可证数，则抛出错误， 否则更新‘有效的许可证数’
